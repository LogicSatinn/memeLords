                ...
                <div class="lg:w-1/2 space-y-7">
                    ...
                    <div class="user_story grid md:grid-cols-4 grid-cols-3 gap-2 relative">
                        ...
                        <a href="#create-post" uk-toggle="target: body ; cls: story-active">
                            <div class="single_story">
                                ...
                                <div class="story-avatar"><img src="{{ asset('assets/images/avatars/avatar-1.jpg')}}"
                                                               alt=""></div>
                        ...
                        <a href="#" uk-toggle="target: body ; cls: story-active">
                            <div class="single_story">
                                ...
                                <div class="story-avatar"><img src="{{ asset('assets/images/avatars/avatar-2.jpg')}}"
                                                               alt=""></div>
                                <div class="story-content"><h4> Jonathan</h4></div>
                            </div>
                        </a>
                        <a href="#" uk-toggle="target: body ; cls: story-active">
                            <div class="single_story">
                                ...
                                <div class="story-avatar"><img src="{{ asset('assets/images/avatars/avatar-3.jpg')}}"
                                                               alt=""></div>
                                <div class="story-content"><h4> Jonathan</h4></div>
                            </div>
                        </a>
                        <a href="#" uk-toggle="target: body ; cls: story-active">
                            <div class="single_story">
                                ...
                                <div class="story-avatar"><img src="{{ asset('assets/images/avatars/avatar-4.jpg')}}"
                                                               alt=""></div>
                                <div class="story-content"><h4> Jonathan</h4></div>
                            </div>
                        </a>
                    ...
                    <div class="card lg:mx-0 p-4" uk-toggle="target: #create-post-modal">
                        ...
                        <div class="grid grid-flow-col pt-3 -mx-1 -mb-1 font-semibold text-sm">
                            ...
                            <div class="hover:bg-gray-100 flex items-center p-1.5 rounded-md cursor-pointer">
                                <svg
                                    class="bg-red-100 h-9 mr-2 p-1.5 rounded-full text-red-600 w-9 -my-0.5 hidden lg:block"
                    ...
                    <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                        ...
                        <div uk-lightbox>
                            <div class="grid grid-cols-2 gap-2 px-5">
                                ...
                                <a href="{{ asset('assets/images/post/img-4.jpg')}}" class="col-span-2">
                                    <img src="{{ asset('assets/images/post/img-4.jpg')}}" alt=""
                                         class="rounded-md w-full lg:h-76 object-cover">
                                </a>
                                <a href="{{ asset('assets/images/post/img-4.jpg')}}">
                                    <img src="{{ asset('assets/images/post/img-2.jpg')}}" alt=""
                                         class="rounded-md w-full h-full">
                                </a>
                                <a href="{{ asset('assets/images/post/img-4.jpg')}}" class="relative">
                                    <img src="{{ asset('assets/images/post/img-3.jpg')}}" alt=""
                                         class="rounded-md w-full h-full">
                                    <div
