            ...
            >
                ...
                <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                    ...
                    <x-frontend.form-section action="{{ route('register') }}">
                        <x-slot:form>
                            <div class="flex flex-row items-center justify-center lg:justify-start space-x-1.5">
                                <p class="text-lg mb-0 mr-4">Sign up with</p>

                                <x-tw-elements.buttons-with-icons style="background-color: #F4B400;" href="#">
                                    <path
                                        d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"/>
                                </x-tw-elements.buttons-with-icons>

                                <x-tw-elements.buttons-with-icons style="background-color: #55acee" href="#">
                                    <path
                                ...
                                <x-tw-elements.buttons-with-icons style="background-color: #ed66b0" href="#">
                                    <path
