        ...
        <div class="container px-6 py-12 h-full">
            <div class="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
                ...
                <div class="md:w-8/12 lg:w-5/12 lg:ml-20">
                    ...
                    <x-tw-elements.links-with-icons style="background-color: #F4B400;" href="#">
                        <!-- Gmail -->
                        <x-slot:path>
                            <path
                    ...
                    </x-tw-elements.links-with-icons>

                    <x-tw-elements.links-with-icons style="background-color: #55acee" href="#">
                        <x-slot:path>
                            <path
                    ...
                    <x-tw-elements.links-with-icons style="background-color: #ed66b0" href="#">
                        <x-slot:path>
                            <path
