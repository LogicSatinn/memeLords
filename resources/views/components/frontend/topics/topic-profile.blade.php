...
<div class="profile is_group">
    ...
    <!-- search icon -->
    <a href="#" class="flex items-center justify-center h-10 w-10 rounded-md bg-gray-100 z-10 absolute bottom-2 right-3"
    ...
    <div class="absolute bg-white border bottom-2 right-3 rounded-md z-20" id="profile-search" hidden>
        ...
        <ion-icon name="close-outline"
                  class="text-2xl hover:bg-gray-100 p-1 rounded-full cursor-pointer absolute right-2 bottom-1.5"
