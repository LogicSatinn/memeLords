        ...
        <div class="max-w-2xl m-auto shadow-md rounded-md bg-white lg:mt-20">
            ...
            <div class="p-10 space-y-7">
                ...
                <div class="line">
                    <input class="line__input" id="name" name="name" type="text"
                           ...
                           value="{{ Str::of($topic->name)->after('#')->title() }}" autocomplete="off">
                ...
                <div>
                    ...
                    <select id="category" name="category[]" multiple class="shadow-none selectpicker with-border">
                        @foreach($categories as $key => $value)
                            <option
                                value="{{ $key }}" @selected(old('category') == $key)>{{ $value }}</option>
                        @endforeach
                    </select>
                    @error('category')
                    <div class="bg-red-100 rounded-lg py-5 px-6 mb-4 text-base text-red-700 mb-3" role="alert">
            ...
            <textarea class="line__input h-32" id="description" name="description" type="text"
                ...
                <div uk-form-custom class="w-full py-3">
                    <div
                        class="bg-gray-100 border-2 border-dashed flex flex-col h-32 items-center justify-center relative w-full rounded-lg">
